...
class RowParser {
	...
	/**
	 * To ensure that at the time to populate an object in the target property path, we need to process the precedents
	 * path before. So, the prefixes are sorted by property path length from the minor to the major.
	 */
